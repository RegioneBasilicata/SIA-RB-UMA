...
<%!
  public static final String LAYOUT="macchina/layout/elencoMacchineBis.htm";
...
%>
<%
  SolmrLogger.debug(this,"--------------------------- elencoMacchineBisView.jsp---------------------------");
...
%><%@include file = "/include/menu.inc" %><%
  ...
  if (startRowStr!=null)
  {
    try
    {
      ...
      SolmrLogger.debug(this,"No Eccezioni");
    }
  ...
  session.setAttribute("elencoMacchineBis","BIS");
...
//    htmpl.set("blkMacchina.dataCarico",formatDate(macchinaVO.getDataCaricoDate()));
    ...
    htmpl.set("blkMacchina.dataScarico",macchinaVO.getUtilizzoVO().getDataScarico());
    SolmrLogger.debug(this,"blkMacchina.descScarico="+macchinaVO.getUtilizzoVO().getDescScarico());
    htmpl.set("blkMacchina.descScarico",macchinaVO.getUtilizzoVO().getDescScarico());
    if (matriceVO==null)
    {
