...
<%
  ...
  String iridePageName = "confermaEliminaLavConsorziCtrl.jsp";
  %><%@include file = "/include/autorizzazione.inc" %><%

  UmaFacadeClient umaClient = new UmaFacadeClient();
  String url="/ditta/ctrl/elencoLavConsorziCtrl.jsp";
  String viewUrl="/ditta/view/confermaEliminaLavConsorziView.jsp";
  String elenco="/ditta/ctrl/elencoLavConsorziCtrl.jsp";
  String elencoBis="/ditta/ctrl/elencoLavConsorziBisCtrl.jsp";
  ...
  SolmrLogger.debug(this,"idLavConsorzi.length???? "+idLavConsorzi.length);
   
  DittaUMAAziendaVO dittaUMAAziendaVO=(DittaUMAAziendaVO) session.getAttribute("dittaUMAAziendaVO");
  Long idDittaUma=dittaUMAAziendaVO.getIdDittaUMA();
  
  SolmrLogger.debug(this,"Sono in confermaEliminaLavConsorziCtrl...");
  if (request.getParameter("conferma.x")!=null)
  {
    ...
    try
    {
      	umaClient.deleteLavConsorzi(idLavConsorzi,idDittaUma, ruoloUtenza.getIdUtente());
...
%>
SolmrLogger.debug(this,"confermaEliminaLavConsorziCtrl - End");
