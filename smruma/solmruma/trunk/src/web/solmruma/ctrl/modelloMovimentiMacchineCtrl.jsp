...
<%!
  ...
  private static final String VIEW="../view/modelloMovimentiMacchineView.jsp";

%>

<%
  String iridePageName = "modelloMovimentiMacchineCtrl.jsp";
  ...
  try  {
    ...
    String strIdGenereMacchina = request.getParameter("idGenereMacchina");
    ...
    if (ruoloUtenza.isUtenteIntermediario()) {
      ...
      if (request.getParameter("conferma") != null) {
        ...
        if (!Validator.isNotEmpty(strIdGenereMacchina)) {

          errors.add("idGenereMacchina",new ValidationError("Selezionare un genere macchina"));
