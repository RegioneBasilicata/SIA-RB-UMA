...
<%
  ...
  String iridePageName = "datiSerreAziendaPOPCtrl.jsp";
  %><%@include file = "/include/autorizzazione.inc" %><%

  SolmrLogger.debug(this, "   BEGIN datiSerreAziendaPOPCtrl");
  
  ValidationErrors errors = new ValidationErrors();
  String dettaglioUrl = "/domass/view/datiSerreAziendaPOPView.jsp";
  ...
  */
  ...
  try{    
    Vector vect = umaFacadeClient.getDettaglioAssegnazioneSerre(idDomAss,tipoAssegnazione,numSupplemento);
    ...
    SolmrLogger.error(this, "--- SolmrException in datiSerreAziendaPOPCtrl ="+se.getMessage());
