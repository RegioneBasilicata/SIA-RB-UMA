...
<%
  ...
  Htmpl htmpl = HtmplFactory.getInstance(application).getHtmpl("domass/layout/dettaglioVerificaAcconto.htm");
...
%><%@include file = "/include/menu.inc" %><%
  ...
  if (assegnazioniCarburante!=null && assegnazioniCarburante.size()==1)
  {
    ...
    if (utenteIrideVO!=null)
    {
/*      out.println("utente="+utenteIrideVO.getDenominazione()+"<br><br>");
      out.println("descrizioneEnte="+utenteIrideVO.getDescrizioneEnteAppartenenza()+"<br><br>");*/
