...
<%
  ...
  Htmpl htmpl = HtmplFactory.getInstance(application).getHtmpl("macchina/layout/dettaglioUtilizzo.htm");
%><%@include file = "/include/menu.inc" %><%
  ...
  if (ruoloUtenza!=null && ruoloUtenza.isUtenteProvinciale()){
    ...
    if(ruoloUtenza.isReadWrite()&&ruoloUtenza.getIstatProvincia().equals(dittaUMAAziendaVO.getProvUMA()))
  ...
  if(macchinaVO != null){
    ...
    if(uVO!=null){
      ...
      SolmrLogger.debug(this, "--- idUtilizzo ="+uVO.getIdUtilizzo());
      htmpl.set("idUtilizzo", uVO.getIdUtilizzo());
      ...
      if(rVO!=null){
        ...
        String tda = rVO.getCharTipoDataAnzianita();
        ...
        String dts = rVO.getCharDestTargaStradale();
        ...
        String dtu = rVO.getCharDestTargaUma();
        ...
        String dlc = rVO.getCharDestLibrettoCircolaz();
