...
<%!
  private static final String NEXT_PAGE="../layout/calcoloAutomaticoFOfineAssSuppl.htm";
%>
<%
...
<%  
  ...
  SolmrLogger.debug(this, "   BEGIN calcoloAutomaticoFOAssSupplView");

  HtmplUtil.setErrors(htmpl, (ValidationErrors)request.getAttribute("errors"), request);
  String idDittaUmaStr=request.getParameter("idDittaUma");
  ...
  try{
    ...
    Long[] cdOutputCalcoloSupplemento = client.calcoloAutomaticoAssSupPL(idDittaUma,idUtente,idUtente,tipoAssegnazioneSupplementare);
  ...
  {
    SolmrLogger.error(this, "--- SolmrException in calcoloAutomaticoFOAssSupplView ="+e.getMessage()); 
    ...
    SolmrLogger.debug(this, "   END calcoloAutomaticoFOAssSupplView");
  }
    %>
<script language="javascript1.2">
