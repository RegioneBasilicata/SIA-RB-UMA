...
<%!
  ...
  public static final String PAGE_NAME="confermaEliminaMarca";
  public static final String MSG_RICHIESTA_CONFERMA="Si vuole procedere con l'eliminazione della marca selezionata?";
%>
<%
