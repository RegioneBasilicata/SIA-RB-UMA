...
<%!
  private static final String VIEW="/macchina/view/macchinaUsataTrovataUtilizzoCasoR-ASMView.jsp";
  private static final String PREV="../layout/macchinaUsataTrovataDatiCasoR-ASM.htm";
...
<%
  ...
  String iridePageName = "macchinaUsataTrovataUtilizzoCasoR-ASMCtrl.jsp";
  ...
  try
  {
    ...
    SolmrLogger.debug(this,"macchinaUsataTrovataUtilizzoCasoR-ASMCtrl.jsp");
    if (request.getParameter("salva")!=null)
    {
      ...
      {
        tipoNuovaTarga=SolmrConstants.TARGA_STRADALE_RA;
      ...
      if (errors!=null && errors.size()==0)
      {
        ...
        MovimentiTargaVO movimentiTargaVO=umaClient.acquistaMacchinaUsataConTarga(dittaUMAAziendaVO,
                                                targaVO,
                                                new Long(dittaProvenienzaVO.getDittaUMA()),
                                                dittaProvenienzaVO.getProvincia(),
                                                tipoNuovaTarga,
                                                possessoVO,
                                                ruoloUtenza);
...
//        movimentiTargaVO=umaClient.getMovimentazioneById(movimentiTargaVO.getIdMovimentiTargaLong());
        ...
        if (tipoNuovaTarga==null)
        {
          ...
          SolmrLogger.debug(this,"Caso R-ASM");
          SolmrLogger.debug(this,"modello49VO.getAnnoModello49(): "+modello49VO.getAnnoModello49());
          SolmrLogger.debug(this,"modello49VO.getNumeroModello49(): "+modello49VO.getNumeroModello49());
        ...
        {
          SolmrLogger.debug(this,"movimentiTargaVO.getDatiTarga().getNumeroTarga()="+movimentiTargaVO.getDatiTarga().getNumeroTarga());
        }
  ...
  {
    SolmrLogger.debug(this,"********************************************************************");
    SolmrLogger.debug(this,"Catched exception "+e.getMessage());
    SolmrLogger.debug(this,"********************************************************************");
  ...
  SolmrLogger.debug(this,"forwarding to "+VIEW);
%>
<jsp:forward page="<%=VIEW%>"/>
<%
  SolmrLogger.debug(this,"forward executed");
%>
<%!
...
//    String tipoTarga=request.getParameter("tipoTarga");
    ...
    /*if (leasingRequired)
    {
      ...
      if (errors.get("dataScadenzaLeasing")==null && errors.get("dataCarico")==null)
      {
        Date dataCaricoDate=DateUtils.parseDate(dataCarico);
        Date dataScadenzaLeasingDate=DateUtils.parseDate(dataScadenzaLeasing);
        if (dataCaricoDate.compareTo(dataScadenzaLeasingDate)>=0)
        {
          errors.add("dataScadenzaLeasing",new ValidationError("La data di scadenza leasing deve essere posteriore alla data di carico"));
        }
      }
    }*/
    return errors;
