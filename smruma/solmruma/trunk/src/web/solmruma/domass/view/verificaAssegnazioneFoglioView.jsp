...
<%
    SolmrLogger.debug(this,"\n\n\n - verificaAssegnazioneFoglioView - Begin");
    DittaUMAAziendaVO dittaUMAAziendaVO=(DittaUMAAziendaVO) session.getAttribute("dittaUMAAziendaVO");
    Long idDittaUma=dittaUMAAziendaVO.getIdDittaUMA();
    RuoloUtenza ruoloUtenza = (RuoloUtenza) session.getAttribute("ruoloUtenza");


    String layoutUrl = "/domass/layout/verificaAssegnazioneFoglio.htm";
...
%><%@include file = "/include/menu.inc" %><%
    ...
    if (numFogliResult!=null){
      ...
      for(int i=0; i<size; i++){
        ...
        if(numFoglioVO.getDenominazione() != null){
    ...
    SolmrLogger.debug(this,"verificaAssegnazioneFoglioView - End");
%>