...
<%!
  ...
  private static final String VIEW="../view/modelloContatoriView.jsp";

%>

<%
  String iridePageName = "modelloContatoriCtrl.jsp";
...

  {
    ...
    String strDataInizio = (request.getParameter("dataUtente")!=null?request.getParameter("dataUtente"):"");
    ...
    if (ruoloUtenza.isUtenteIntermediario()) {
      ...
      if (request.getParameter("conferma") != null) {
        ...
        Validator.validateDateAll(strDataInizio, "dataUtente", "data sistuazione", errors, true, false);
