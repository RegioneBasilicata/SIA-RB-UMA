...
<%!// Costanti
  private static final String LAYOUT = "/domass/layout/verificaAssegnazioneAccontoSalvata.htm";%>
<%
...
<%
  ...
  {
/*     if (SolmrConstants.IDCONDUZIONECONTOPROPRIO.toString().equals(dittaUMAAziendaVO.getIdConduzione()))
    {
