...
<%!
  public static final String LAYOUT="layout/modello74.htm";
%>
<%
...
%><%@include file = "/include/menu.inc" %><%
  ...
  if (request.getParameter("conferma") == null) {
    htmpl.set("dataInizioI", "");
    htmpl.set("dataFineI", "");
    //htmpl.set("dataFineI", DateUtils.formatDate(new Date()));
  }
  ...
  if (request.getAttribute("errors") != null) {
    ...
    if (request.getParameter("conferma") != null) {
      ...
      htmpl.set("scriptModello74", "stampaModello74()");
    }
  }
