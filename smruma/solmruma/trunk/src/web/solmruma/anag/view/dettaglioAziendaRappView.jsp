...
<%
  ...
  Htmpl htmpl = HtmplFactory.getInstance(application)
                ...
                .getHtmpl("/anag/layout/dettaglioAziendaRapp.htm");
...
%><%@include file = "/include/menu.inc" %><%
  ...
  if(personaVO!=null){
    ...
    if(personaVO.getNascitaCittaEstero()!= null && !personaVO.getNascitaCittaEstero().equals("")){
      ...
      htmpl.newBlock("blkComuneNascitaEstero");

      htmpl.set("blkComuneNascitaEstero.comune_estero_nascita", personaVO.getNascitaCittaEstero());

    }

    if(personaVO.getNascitaComune()!=null && !personaVO.getNascitaComune().equals("")){

      htmpl.newBlock("blkISTAT");
    ...
    htmpl.set("res_indirizzo", personaVO.getResIndirizzo());

    if(personaVO.getStatoEsteroRes()==null||personaVO.getStatoEsteroRes().equals("")){

      htmpl.newBlock("blkStatoItalia");

      htmpl.set("blkStatoItalia.res_prov", personaVO.getDescResProvincia());

      htmpl.set("blkStatoItalia.res_comune", personaVO.getDescResComune());

      htmpl.set("blkStatoItalia.res_cap", personaVO.getResCAP());
      ...
      htmpl.set("blkStatoEstero.res_stato_estero", personaVO.getStatoEsteroRes());

      htmpl.set("blkStatoEstero.res_citta_estero", personaVO.getResCittaEstero());
