...
<%
  Htmpl htmpl = HtmplFactory.getInstance(application)
                .getHtmpl("domass/layout/confermaValidazioneDomanda.htm");
...
<%  
  ...
  {
    htmpl.set("messaggio",UmaErrors.MSGFOGLIORIGAASSCARBBASE);
  }
  else
  {
    htmpl.set("messaggio",UmaErrors.MSGFOGLIORIGAASSCARBSUPP);
  }
  HtmplUtil.setValues(htmpl,frmVerificaAssegnazioneVO,(String)session.getAttribute("pathToFollow"));
