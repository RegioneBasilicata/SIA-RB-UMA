...
<%
  SolmrLogger.debug(this, "   BEGIN calcoloAutomaticoBOfineAssSupplView");
  ...
  Htmpl htmpl = HtmplFactory.getInstance(application)
                .getHtmpl("domass/layout/calcoloAutomaticoAssegnazioneSupplFine.htm");
%><%@include file = "/include/menu.inc" %><%
  RuoloUtenza ruoloUtenza = (RuoloUtenza) session.getAttribute("ruoloUtenza");

  HtmplUtil.setErrors(htmpl, (ValidationErrors)request.getAttribute("errors"), request);

  htmpl.set("action","../layout/verificaAssegnazioneSupplementareBO.htm");
 ...
 if(common != null){
  ...
  SolmrLogger.debug(this, "   END calcoloAutomaticoBOfineAssSupplView");  
