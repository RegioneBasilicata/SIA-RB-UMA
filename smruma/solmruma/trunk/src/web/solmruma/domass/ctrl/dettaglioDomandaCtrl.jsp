...
<%!
  ...
  public static final String VIEW_URL="/domass/view/dettaglioDomandaView.jsp";

  public static final String DETTAGLIO_VERIFICA_ASSEGNAZIONE_URL = "/domass/ctrl/dettaglioVerificaAssegnazioneCtrl.jsp";
  public static final String DETTAGLIO_ASSEGNAZIONI_SUPPLEMENTARE_URL = "/domass/ctrl/dettaglioAssegnazioniSupplementareCtrl.jsp";
%>
...
<%
  ...
  DomandaAssegnazione da = (DomandaAssegnazione) request.getAttribute("DOMANDA_ASSEGNAZIONE");
  Long idDomAss = null;
  if (request.getParameter("idDomAss") != null){
    idDomAss = new Long(request.getParameter("idDomAss"));
    SolmrLogger.debug(this, "--- idDomAss in dettaglioDomandaCtrl ="+idDomAss);
  }
  if (da == null)
  {
  ...
  return;
    ...
    else
    {
          ...
          "dettaglioAssegnazioniSupplementari"))
      {
        ...
        SolmrLogger.debug(this,"request.getParameter(\"annullaBuoni\").equalsIgnoreCase("
                + DETTAGLIO_ASSEGNAZIONI_SUPPLEMENTARE_URL + ")");
%>
<jsp:forward page="<%=DETTAGLIO_ASSEGNAZIONI_SUPPLEMENTARE_URL%>" />
<%
  return;
      }
    }
